...
$('copy-debug').onclick=async()=>{
 ...
 const report={
  ...
  engine:'Rust/WASM',profile:'expanded',ranking:'scowl-context-v4+family-v1+island-v1',
  options:options(),
...
$('capture-case').onclick=()=>{
 ...
 caseSnapshot={raw:$('raw').value,options:options(),selectedRank:candidates.length?selected+1:null,dictionary:dictionarySize(),ranking:'scowl-context-v4+family-v1+island-v1'};
